		...
		<div class="container mx-auto bg-white px-4">
			...
			<div class="grid gap-8 md:grid-cols-3">
				{#each [
					{ 
						...
						description: "Automatically detects and skips sponsored segments in videos so you don't have to manually skip them.", 
						color: 'bg-red-500' 
					}, 
					{ 
						icon: Zap, 
						title: 'Lightning Fast', 
						description: 'Minimal impact on performance. Works silently in the background without slowing down your browsing.', 
						color: 'bg-yellow-400' 
					}, 
					{ 
						icon: Clock, 
						title: 'Time Saved Tracker', 
						description: "See exactly how much time you've saved by skipping sponsorships across all your watched videos.", 
						color: 'bg-blue-500' 
					}
				] as feature, index}
					<div
			...
			>
				...
				<div class="grid items-center gap-8 md:grid-cols-2">
					...
					<div class="relative">
						<div class="border-4 border-black bg-white p-6 relative">
							<h4 class="text-2xl font-bold mb-3 border-b-2 border-black pb-2">How It Works</h4>
							<div class="space-y-4">
								<div class="flex items-start">
									<div class="bg-red-500 text-white p-1 mr-3 mt-1">
										<span class="font-bold">1</span>
									</div>
									<div>
										<h5 class="font-bold text-lg">Audio Analysis</h5>
										<p>
											Our AI listens for key phrases like "this video is sponsored by" or "use code" that indicate
											sponsorship content.
										</p>
									</div>
								</div>
								...
								<div class="flex items-start">
									<div class="bg-yellow-400 text-black p-1 mr-3 mt-1">
										<span class="font-bold">2</span>
									</div>
									<div>
										<h5 class="font-bold text-lg">Visual Detection</h5>
										<p>
											We identify sponsor logos, product placements, and visual cues that creators use during
											sponsored segments.
										</p>
									</div>
								</div>
								...
								<div class="flex items-start">
									<div class="bg-blue-500 text-white p-1 mr-3 mt-1">
										<span class="font-bold">3</span>
									</div>
									<div>
										<h5 class="font-bold text-lg">Community Data</h5>
										<p>
											Our database is constantly updated with user-reported sponsorship segments across millions of
											videos.
										</p>
									</div>
								</div>
								...
								<div class="flex items-start">
									<div class="bg-green-500 text-white p-1 mr-3 mt-1">
										<span class="font-bold">4</span>
									</div>
									<div>
										<h5 class="font-bold text-lg">Instant Skipping</h5>
										<p>
											When a sponsorship is detected, we automatically skip ahead to the relevant content - no manual
											interaction needed!
										</p>
									</div>
								</div>
